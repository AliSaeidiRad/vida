...
The model is designed to handle five distinct classification tasks, each mapped to a specific classification head. The classes for each task are detailed in Table \ref{table:label_mapping}.


\begin{center}
    \captionof{table}{Task Definitions and Class Mappings}
    \label{table:label_mapping}
    \begin{tabular}{|c|c|c|c|c|c|}
        \hline
        Head                    & Label                           & Class              & Head                        & Label     & Class \\ \hline
        \multirow{3}{*}{Shape}  & Irregular                       & 0                  & \multirow{5}{*}{BI-RADS}    & 0         & 0     \\ \cline{2-3} \cline{5-6} 
                                & Oval                            & 1                  &                             & 2         & 1     \\ \cline{2-3} \cline{5-6} 
                                & Round                           & 2                  &                             & 3         & 2     \\ \cline{1-3} \cline{5-6} 
        \multirow{6}{*}{Margin} & Spiculated                      & 0                  &                             & 4         & 3     \\ \cline{2-3} \cline{5-6} 
                                & Ill-Defined                     & 1                  &                             & 5         & 4     \\ \cline{2-6} 
                                & Circumscribed                   & 2                  & \multirow{2}{*}{Pathology}  & Malignant & 0     \\ \cline{2-3} \cline{5-6} 
                                & Obscured                        & 3                  &                             & Benign    & 1     \\ \cline{2-6} 
                                & \multirow{2}{*}{MicroLobulated} & \multirow{2}{*}{4} & \multirow{2}{*}{Malignancy} & Low       & 0     \\ \cline{5-6} 
                                &                                 &                    &                             & High      & 1     \\ \hline
    \end{tabular}
\end{center}
...
The static hyperparameters utilized for training, designed specifically for the unique distributions of each mammogram ROI task, are detailed in Table \ref{table:hyperparams}.

\begin{center}
    \captionof{table}{Hyperparameter Configurations per Task}
    \label{table:hyperparams}
    \begin{tabular}{|c|c|c|c|}
        \hline
        Task       & Focusing Parameter & Label Smoothing & Task Weight \\ \hline
        Shape      & 1.0                & 0.05            & 1.2         \\ \hline
        Margin     & 1.5                & 0.1             & 1.5         \\ \hline
        Pathology  & 2.0                & 0.05            & 1.0         \\ \hline
        BI-RADS    & 1.0                & 0.1             & 2.0         \\ \hline
        Malignancy & 1.5                & 0.05            & 1.0         \\ \hline
    \end{tabular}
\end{center}
